...
function () {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(WarUser, [{
    ...
    key: "score",
    get: function get() {
      return (this.wins * (this.wins / this.battles) - this.battlesMissed * 2.5 + this.wins * 0.5).toFixed(2);
    }
  }]);
...
var WarPerformance = function WarPerformance(props) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_3___default.a.Fragment, null, __jsx("header", {
    ...
    var className = p.score < -1 ? 'bg-danger' : p.score <= 0 ? 'table-danger' : p.score >= 5 && p.score < 7 ? 'table-success' : p.score >= 7 ? 'table-warning' : null;
    return __jsx("tr", {
      key: i,
      className: "jsx-309811624",
      __source: {
...
//# sourceMappingURL=index.js.24c3dedd71f207db29b8.hot-update.js.map