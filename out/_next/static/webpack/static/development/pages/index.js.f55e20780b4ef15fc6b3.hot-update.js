...
function () {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(WarUser, [{
    ...
    key: "score",
    get: function get() {
      return ((this.wins * (this.wins / this.battles) - this.battlesMissed * this.battlesMissed + this.wins * 0.5) * this.ratio).toFixed(2) / 15 * 100;
    }
  }]);
...
//# sourceMappingURL=index.js.f55e20780b4ef15fc6b3.hot-update.js.map