...
function () {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(WarUser, [{
    ...
    key: "score",
    get: function get() {
      var missedMod = this.battles - this.totalBattles + 1;
      return this.wins * this.ratio * (this.wins / this.totalBattles) * missedMod; // return ((this.wins * (this.wins / this.battles)) - (this.battlesMissed * 1.5)).toFixed(2)
    }
  }]);
...
//# sourceMappingURL=index.js.ca2eb68592ab7b86b2ed.hot-update.js.map