...
var WarPerformance = function WarPerformance(props) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_3___default.a.Fragment, null, __jsx("header", {
    ...
    var className = p.score < 0 ? 'bg-danger' : p.score < 1 ? 'table-danger' : p.score >= 8 ? 'table-warning' : 'table-success';
    return __jsx("tr", {
      key: i,
      className: "jsx-309811624",
      __source: {
...
//# sourceMappingURL=index.js.9cdea5ca8a1245e8cae7.hot-update.js.map