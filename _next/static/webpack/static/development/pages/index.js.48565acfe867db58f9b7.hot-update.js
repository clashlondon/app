...
function () {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(WarUser, [{
    ...
    key: "score",
    get: function get() {
      return this.wins + this.wins * (this.battles - this.totalBattles); // return ((this.wins * (this.wins / this.battles)) - (this.battlesMissed * 1.5)).toFixed(2)
    }
  }]);
...
//# sourceMappingURL=index.js.48565acfe867db58f9b7.hot-update.js.map