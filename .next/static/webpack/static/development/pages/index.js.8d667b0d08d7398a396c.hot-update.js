...
function () {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(WarUser, [{
    ...
    get: function get() {
      ...
      return this.wins * this.ration * (this.wins / this.totalBattles) * missedMod; // return ((this.wins * (this.wins / this.battles)) - (this.battlesMissed * 1.5)).toFixed(2)
    }
  }]);
...
//# sourceMappingURL=index.js.8d667b0d08d7398a396c.hot-update.js.map