...
var WarPerformance = function WarPerformance(props) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_3___default.a.Fragment, null, __jsx("header", {
    ...
    var className = p.score < -1 ? 'bg-danger' : p.score <= 0 ? 'table-danger' : p.score >= 6 && p.score < 7.5 ? 'table-success' : p.score >= 8 ? 'table-warning' : null;
    return __jsx("tr", {
      key: i,
      className: "jsx-309811624",
      __source: {
...
//# sourceMappingURL=index.js.8c78a3cbcf0f49a92fa7.hot-update.js.map