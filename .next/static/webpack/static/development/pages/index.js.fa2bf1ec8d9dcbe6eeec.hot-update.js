...
var WarPerformance = function WarPerformance(props) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_3___default.a.Fragment, null, __jsx("header", {
    ...
    var className = p.score <= -2 ? 'bg-danger' : p.score <= 0 ? 'table-danger' : p.score >= 8 ? 'table-warning' : 'table-success';
    return __jsx("tr", {
      key: i,
      className: "jsx-309811624",
      __source: {
...
//# sourceMappingURL=index.js.fa2bf1ec8d9dcbe6eeec.hot-update.js.map