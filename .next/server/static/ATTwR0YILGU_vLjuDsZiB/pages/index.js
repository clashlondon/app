...
const ClanPage = props => {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx("header", {
    className: "p-4"
  }, __jsx("h1", null, "Warlog")), __jsx(_components_WarPerformance__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"], _extends({
    clan: props.clan
  }, props.warlog)));
};

ClanPage.getInitialProps = async function () {
  const warlog = await Object(_api__WEBPACK_IMPORTED_MODULE_1__[/* WarLog */ "b"])();
  warlog.items.reverse(); // flip order or wars oldest first

  const clan = await Object(_api__WEBPACK_IMPORTED_MODULE_1__[/* Clan */ "a"])();
  return {
    warlog,
    clan
  };
